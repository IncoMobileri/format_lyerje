		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formular Lyerje",
									"targetURL": "#npmlyerjeformularlyerje-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"npmlyerjeformularlyerje-display": {
								"semanticObject": "npmlyerjeformularlyerje",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=npmlyerje.formularlyerje",
									"url": sap.ui.require.toUrl("npmlyerje/formularlyerje")
								}
							}
						}
					}
